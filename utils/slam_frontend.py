...
class FrontEnd(mp.Process):
    ...
    def tracking(self, cur_frame_idx, viewpoint, last_keyframe_idx):
        ...
        #                   cur_frame_idx, self.save_dir, out_dir="track", mask=dynamic_mask)  #self.gaussians._xyz出现NAN??
        ...
        for tracking_itr in range(self.tracking_itr_num):
            ...
            loss_tracking = get_loss_tracking(
                self.config, image, depth, opacity, viewpoint, rm_dynamic=True, mask=mask, #not self.dynamic_model
            )
        ...
        while True:
            ...
            if self.frontend_queue.empty():
                ...
                if create_kf:
                    ...
                    print("create keyframe: ", cur_frame_idx, "add new gaussian: ", True, "point_ratio: ", point_ratio, "dynamic_render", dynamic_render)
