...
class ControlNodeWarp(nn.Module):
    ...
    def as_gaussians(self):
        if not hasattr(self, 'gs') or self.gs is None:
            ...
            from thirdparty.gaussian_splatting.scene.gaussian_model import GaussianModel, BasicPointCloud, StandardGaussianModel
    ...
    def as_gaussians_visualization(self):
        from thirdparty.gaussian_splatting.scene.gaussian_model import GaussianModel, BasicPointCloud
